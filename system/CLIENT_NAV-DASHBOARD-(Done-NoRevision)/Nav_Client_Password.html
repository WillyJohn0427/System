...
<img src="Profile.png" class="rounded-full h-14 w-14 object-cover" alt="User Avatar">
</div>
</div>
</header>
        ...
        <main class="flex flex-col items-center w-full h-screen pl-60 padding-top: 700px pt-[180px] ">
            ...
            <div class="bg-white shadow-md w-full max-w-6xl rounded-t-2xl  rounded-b-2xl pb-[193px]">
                ...
                <div class="flex ml-8 mt-[25px] ">
                    <button class="px-4 pr-[187px] py-2 text-lg font-[600] text-black rounded-xl hover:bg-red-900 transition-all hover:text-white">Profile</button>
                </div>
