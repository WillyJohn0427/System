...
<head>
    ...
    <link rel="icon" href="{{ asset('images/Chief_images/QAC.jpeg') }}">
...
<body class="bg-gray-100">
    ...
    <aside class="h-screen w-64  bg-white text-black p-5 fixed h-full shadow-[4px_0_6px_-1px_rgba(0,0,0,0.1)] z-10 pt-[157px] fixed top-0 left-0 h-screen z-10 overflow-y-auto"">
        ...
        <div class="flex flex-col items-center w-full h-screen pl-[223px] padding-top: 700px pt-[180px] ">
            <!-- Settings Container -->
            <div class="bg-white shadow-md w-full max-w-6xl rounded-t-2xl  rounded-b-2xl pb-[5px]">
                ...
                <div class="flex ml-8 mt-[25px] ">
                    <a href="{{ route('profile1') }}" class="px-4 pr-[187px] py-2 text-lg font-[600] text-black rounded-xl hover:bg-red-900 transition-all hover:text-white">Profile</a>
                </div>
                <div class="flex ml-8 mt-2">
                    <a href="{{ route('password1') }}" class="px-4 pr-[164px] py-2 text-lg font-[600] text-black rounded-xl hover:bg-red-900 transition-all hover:text-white">Password</a>
                </div>
                <div class="flex ml-8 mt-2">
                    <a href="{{ route('activity') }}" class="px-4 pr-[145px] py-2 text-lg font-[600] text-black rounded-xl hover:bg-red-900 transition-all hover:text-white">Activity Log</a>
                </div>
                <div class="flex ml-8 mt-2">
                    <a href="{{ route('backup') }}" class="px-4 pr-[141px] py-2 text-lg font-[600] text-white rounded-xl bg-red-900">Backup Files</a>
                </div>
        
                <!-- Profile Section -->
                <div class="p-6 max-w-[800px] ml-[330px] -mt-[224px]">
                    <h2 class="text-xl font-[700] text-gray-900">Backup Files</h2>
                    <p class="text-gray-800 mb-[40px]">Export your data</p>

                    <!-- Larger Download Card -->
                    <div class="flex flex-col items-center px-16 py-32 border border-black rounded-3xl w-full max-w-2xl mx-auto shadow-md -ml-[1px] pb-[150px]">
                        <div class="w-[60px] h-[60px] bg-gray-300 rounded-full flex items-center justify-center -mt-[30px]">
                            <svg class="w-[50px] h-[50px] text-white" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Title -->
                        <h2 class="text-xl font-bold text-gray-900 my-4 text-center">Download all your files</h2>

                        <!-- Subtitle -->
                        <p class="text-gray-700 text-base text-center mb-6 max-w-xl">
                            Files and user information are available to download
                        </p>

                        <!-- Download Button -->
                        <div class="flex gap-6 mt-2 items-left mb-2">
                            <button class="flex items-center gap-2 px-6 py-3 pr-8 border border-black rounded-full bg-red-900 text-white hover:bg-red-800 hover:text-white text-lg">
