    ...
    <aside class="h-screen w-64  bg-white text-black p-5 fixed h-full bg-black shadow-[4px_0_6px_-1px_rgba(0,0,0,0.1)] z-10 pt-[157px] fixed top-0 left-0 h-screen z-10 overflow-y-auto"">
        ...
        <main class="flex flex-col items-center w-[full] mt-4 p-4 pt-[164px] pl-60">
            ...
            <div class="bg-white shadow-md w-full h-[750px] rounded-t-2xl rounded-b-2xl ml-[15px]" style="max-width: 1500px;">
                ...
                <!-- Event Button -->
                <a href="{{ route('chief.event2') }}" class="bg-red-900 text-white text-lg px-4 py-2 ml-[70px] rounded-xl flex items-center space-x-2 hover:bg-red-800 transition-all shadow-md">
