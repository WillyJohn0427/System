...
<div class="flex-1 bg-gray-100 pt-[20px] ml-[320px] mr-[50px]">
  <div class="flex justify-between items-center mb-5">
    ...
    <div class="mb-5 flex flex-col items-start">
        ...
        <!-- New Button + Title -->
        <div>
          <h2 class="text-2xl font-bold ml-[30px]">PUP Campuses > BANSUD, ORIENTAL MINDORO > Certificate of Compliance (COPC)</h2>
        </div>
      </div>
      ...
      <div class="flex items-center space-x-4 mr-[30px]">
        <button class="bg-white text-red-900 text-lg px-4 py-1.5 ml-[30px] mt-2.5 rounded-2xl font-semibold border border-red-900 flex items-center space-x-2 hover:bg-red-900 hover:text-white transition-all mb-2">
          ...
          <button class="flex rounded-2xl overflow-hidden border border-red-900">
            ...
            <a href="{{ route('documents44') }}" class="bg-white px-4 py-2 flex items-center justify-center">
...
<ul class="mt-8 divide-y divide-gray-200">
  <!-- Example File Row 1 -->
  <li onclick="openImageModal('images/Chief_images/BSED Major in English 2024.pdf.png')" class="grid grid-cols-3 md:grid-cols-7 py-4 px-4 items-center hover:bg-gray-100 cursor-pointer group">
    <div class="flex items-center col-span-3 md:col-span-3 gap-3">
     <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-red-800">
      ...
      <span class="text-gray-800 text-md truncate group-hover:underline">BSED Major in English 2024.pdf</span>
    </div>
  ...
  <!-- Example File Row 2 -->
  <li onclick="openImageModal('images/Chief_images/BSED Major in mathematics 2024.pdf.png')" class="grid grid-cols-3 md:grid-cols-7 py-4 px-4 items-center hover:bg-gray-100 cursor-pointer group">
    <div class="flex items-center col-span-3 md:col-span-3 gap-3">
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-red-800">
        <path d="M21 11V15.8C21 16.9201 21 17.4802 20.782 17.908C20.5903 18.2843 20.2843 18.5903 19.908 18.782C19.4802 19 18.9201 19 17.8 19H6.2C5.0799 19 4.51984 19 4.09202 18.782C3.71569 18.5903 3.40973 18.2843 3.21799 17.908C3 17.4802 3 16.9201 3 15.8V8.2C3 7.0799 3 6.51984 3.21799 6.09202C3.40973 5.71569 3.71569 5.40973 4.09202 5.21799C4.51984 5 5.0799 5 6.2 5H15M21 11L15 5M21 11H16.6C16.0399 11 15.7599 11 15.546 10.891C15.3578 10.7951 15.2049 10.6422 15.109 10.454C15 10.2401 15 9.96005 15 9.4V5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      </svg>
      <span class="text-gray-800 text-md truncate group-hover:underline">BSED Major in Mathematics 2024.pdf</span>
    </div>
    <div class="hidden md:block col-span-2 text-md text-gray-700">Juan De la Cruz</div>
    <div class="hidden md:block col-span-1 text-md text-gray-700">July 01, 2004</div>
  </li>
