...
<body class="bg-gray-100">
    ...
    <!-- Sidebar -->
    <aside class="h-screen w-64 bg-white text-black p-5 fixed top-[130px] left-0 shadow-lg z-10 overflow-y-auto">
            <nav class="ml-2">
                <ul>
                    <ul>
                        <!-- Dashboard -->
        ...
        <div class="flex flex-col items-center w-full h-screen pl-[223px] padding-top: 700px pt-[180px] ">
            ...
            <div class="bg-white shadow-md w-full max-w-6xl rounded-t-2xl  rounded-b-2xl pb-[5px]">
                ...
                <div class="flex ml-8 mt-2">
                    <a href="{{ route('activity') }}" class="px-4 pr-[145px] py-2 text-lg font-[600] text-white rounded-xl bg-red-900">Activity Log</a>
                </div>
                <div class="flex ml-8 mt-2">
                    <a href="{{ route('backup') }}" class="px-4 pr-[142px] py-2 text-lg font-[600] text-black rounded-xl hover:bg-red-900 transition-all hover:text-white">Backup Files</a>
                </div>
