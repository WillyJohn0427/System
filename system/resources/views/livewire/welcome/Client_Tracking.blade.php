                    ...
                    <ul>
                        ...
                        <ul>
                            ...
                            <li class="mb-4 mt-[28px]">
                                <a href="{{ route('cdashboard') }}" class="flex items-center space-x-4 p-2 group transition duration-200">
                            ...
                            <!-- Tracking -->
                            <li class="mb-4">
                                <a href="{{ route('Ctracking') }}" class="flex items-center space-x-4 p-2 border-l-4 border-red-800 group transition duration-200">
