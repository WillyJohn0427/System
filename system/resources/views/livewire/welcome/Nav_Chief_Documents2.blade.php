...
<div class="flex-1 bg-gray-100 pt-[20px] ml-[320px] mr-[50px]">
  <div class="flex justify-between items-center mb-5">
    ...
    <div class="mb-5 flex flex-col items-start">
        ...
        <!-- New Button + Title -->
        <div>
          <h2 class="text-3xl font-bold ml-[30px]">Main Campus</h2>
        </div>
      </div>
      ...
      <div class="flex items-center space-x-4 mr-[30px]">
        <button class="bg-white text-red-900 text-lg px-4 py-1.5 ml-[30px] mt-2.5 rounded-2xl font-semibold border border-red-900 flex items-center space-x-2 hover:bg-red-900 hover:text-white transition-all mb-2">
          ...
          <button class="flex rounded-2xl overflow-hidden border border-red-900">
            ...
            <a href="{{ route('documents3') }}" class="bg-gray-100 px-3 py-2 flex items-center justify-center">
...
<div class="grid grid-cols-7 gap-2">
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">
      ...
      <div class="relative w-32 h-32">
        ...
        <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
          <img src="{{ asset('images/DBoard_images/Graduate School.png') }}" alt="Graduate School" class="w-[55px] h-[55px]" />
        </div>
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">
      <div class="relative w-32 h-32">
        ...
        <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
          <img src="{{ asset('images/DBoard_images/College of Accountancy and Finance.jpg') }}" alt="College of Accountancy and Finance (CAF)" class="w-[55px] h-[55px]" />
        </div>
        <div class="absolute top-5 -right-5" id="dotsDropdownContainer">
          <svg onclick="toggleDropdown(this)" class="w-5 h-5 text-red-800 hover:text-gray-800 cursor-pointer"
            fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 5a2 2 0 1 1 0-4 2 2 0 0 1 0 4Zm0 9a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm0 9a2 2 0 1 1 0-4 2 2 0 0 1 0 4Z" />
          </svg>
          <div
            class="dropdown hidden absolute right-0 z-20 mt-2 w-48 origin-top-right rounded-md bg-red-800 shadow-md ring-1 ring-black ring-opacity-5">
            <div class="py-1 text-[13px] text-white">
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">
        <div class="relative w-32 h-32">
          ...
          <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
            <img src="{{asset ('images/DBoard_images/College of Architecture, Design and the Built Environment.jpg')}}" alt="College of Architecture, Design and the Built Environment (CADBE)" class="w-[55px] h-[55px]" />
          </div>
          <div class="absolute top-5 -right-5" id="dotsDropdownContainer">
            <svg onclick="toggleDropdown(this)" class="w-5 h-5 text-red-800 hover:text-gray-800 cursor-pointer"
              fill="currentColor" viewBox="0 0 24 24">
  ...
  <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">
        ...
        <div class="relative w-32 h-32">
          ...
          <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
            <img src="{{ asset('images/DBoard_images/College of Business Administration.png') }}" alt="College of Business Administration (CBA)" class="w-[55px] h-[55px]" />
          </div>
          <div class="absolute top-5 -right-5" id="dotsDropdownContainer">
            <svg onclick="toggleDropdown(this)" class="w-5 h-5 text-red-800 hover:text-gray-800 cursor-pointer"
              fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">
        ...
        <div class="relative w-32 h-32">
          ...
          <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
            <img src="{{asset('images/DBoard_images/College of Communication.jpg')}}" alt="College of Communication (COC)" class="w-[55px] h-[55px]" />
          </div>
          <div class="absolute top-5 -right-5" id="dotsDropdownContainer">
            <svg onclick="toggleDropdown(this)" class="w-5 h-5 text-red-800 hover:text-gray-800 cursor-pointer"
              fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">
        ...
        <div class="relative w-32 h-32">
          ...
          <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
            <img src="{{asset('images/DBoard_images/College of Computer and Information Sciences.jpg')}}" alt="College of Computer and Information Sciences (CCIS)" class="w-[55px] h-[55px]" />
          </div>
          <div class="absolute top-5 -right-5" id="dotsDropdownContainer">
            <svg onclick="toggleDropdown(this)" class="w-5 h-5 text-red-800 hover:text-gray-800 cursor-pointer"
              fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">
        ...
        <div class="relative w-32 h-32">
          ...
          <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
            <img src="{{ asset('images/DBoard_images/College of Education.jpg') }}" alt="College of Education (CoEd)" class="w-[55px] h-[55px]" />
          </div>
          <div class="absolute top-5 -right-5" id="dotsDropdownContainer">
            <svg onclick="toggleDropdown(this)" class="w-5 h-5 text-red-800 hover:text-gray-800 cursor-pointer"
              fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">
        ...
        <div class="relative w-32 h-32">
          ...
          <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
            <img src="{{ asset('images/DBoard_images/College of Engineering.jpg') }}" alt="College of Engineering (CE)" class="w-[55px] h-[55px]" />
          </div>
          <div class="absolute top-5 -right-5" id="dotsDropdownContainer">
            <svg onclick="toggleDropdown(this)" class="w-5 h-5 text-red-800 hover:text-gray-800 cursor-pointer"
              fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">
        ...
        <div class="relative w-32 h-32">
          ...
          <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
            <img src="{{ asset('images/DBoard_images/College of Human Kinetics.jpg') }}" alt="College of Human Kinetics (CHK)" class="w-[55px] h-[55px]" />
          </div>
          <div class="absolute top-5 -right-5" id="dotsDropdownContainer">
            <svg onclick="toggleDropdown(this)" class="w-5 h-5 text-red-800 hover:text-gray-800 cursor-pointer"
              fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">
        ...
        <div class="relative w-32 h-32">
          ...
          <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
            <img src="{{ asset('images/DBoard_images/College of Political Science and Public Administration.jpg') }}" alt="College of Political Science and Public Administration (CPSPA)" class="w-[55px] h-[55px]" />
          </div>
          <div class="absolute top-5 -right-5" id="dotsDropdownContainer">
            <svg onclick="toggleDropdown(this)" class="w-5 h-5 text-red-800 hover:text-gray-800 cursor-pointer"
              fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">
        ...
        <div class="relative w-32 h-32">
          ...
          <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
            <img src="{{ asset('images/DBoard_images/College of Science.png') }}" alt="College of Science (CS)" class="w-[55px] h-[55px]" />
          </div>
          <div class="absolute top-5 -right-5" id="dotsDropdownContainer">
            <svg onclick="toggleDropdown(this)" class="w-5 h-5 text-red-800 hover:text-gray-800 cursor-pointer"
              fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">
        ...
        <div class="relative w-32 h-32">
          ...
          <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
            <img src="{{ asset('images/DBoard_images/College of Social Sciences and Development.jpg') }}" alt="College of Social Sciences and Development (CSSD)" class="w-[55px] h-[55px]" />
          </div>
          <div class="absolute top-5 -right-5" id="dotsDropdownContainer">
            <svg onclick="toggleDropdown(this)" class="w-5 h-5 text-red-800 hover:text-gray-800 cursor-pointer"
              fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">
        ...
        <div class="relative w-32 h-32">
          ...
          <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
            <img src="{{ asset('images/DBoard_images/College of Tourism, Hospitality and Transportation Management.jpg') }}" alt="College of Tourism, Hospitality and Transportation Management (CTHTM)" class="w-[55px] h-[55px]" />
          </div>
          <div class="absolute top-5 -right-5" id="dotsDropdownContainer">
            <svg onclick="toggleDropdown(this)" class="w-5 h-5 text-red-800 hover:text-gray-800 cursor-pointer"
              fill="currentColor" viewBox="0 0 24 24">
