...
<div class="flex-1 bg-gray-100 pt-[20px] ml-[320px] mr-[50px]">
      ...
      <div class="flex items-center space-x-4 mr-[30px]">
        <button class="bg-white text-red-900 text-lg px-4 py-1.5 ml-[30px] mt-2.5 rounded-2xl font-semibold border border-red-900 flex items-center space-x-2 hover:bg-red-900 hover:text-white transition-all mb-2">
          ...
          <button class="flex rounded-2xl overflow-hidden border border-red-900">
            ...
            <div class="bg-red-900 px-3 py-2 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
              </svg>
            </div>
            <!-- Grid Icon (2x2 circle dots) -->
            <a href="{{ route('documents2') }}" class="bg-white px-4 py-2 flex items-center justify-center">
  ...
  <div class="p-6 -mt-[20px]">
    ...
    <div class="space-y-3 mt-6">
      <!-- Single row -->
      <a href="{{ route('documentsf1') }}" class="block hover:bg-gray-100 rounded-lg transition">
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center px-4">
        ...
        <div class="flex items-center space-x-3 w-full md:w-1/3">
          ...
          <span class="text-[15px] text-black font-medium">Graduate School (GS)</span>
        </div>
      ...
      <!-- 2 -->
      <a href="{{ route('documentsf2') }}" class="block hover:bg-gray-100 rounded-lg transition">
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center px-4">
        <!-- Name + Icon -->
        <div class="flex items-center space-x-3 w-full md:w-1/3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-yellow-500">
          ...
          <span class="text-[15px] text-black font-medium">College of Architecture, Design and the Built Environment (CADBE)</span>
        </div>
      ...
      <!-- 3 -->
      <a href="{{ route('documentsf3') }}" class="block hover:bg-gray-100 rounded-lg transition">
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center px-4">
        <!-- Name + Icon -->
        <div class="flex items-center space-x-3 w-full md:w-1/3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-yellow-500">
      ...
      <!-- 4 -->
      <a href="{{ route('documents3f') }}" class="block hover:bg-gray-100 rounded-lg transition">
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center px-4">
        <!-- Name + Icon -->
        <div class="flex items-center space-x-3 w-full md:w-1/3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-yellow-500">
          ...
          <span class="text-[15px] text-black font-medium">College of Arts and Letters (CAL)</span>
        </div>
      ...
      <!-- 5 -->
      <a href="{{ route('documentsf5') }}" class="block hover:bg-gray-100 rounded-lg transition">
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center px-4">
        <!-- Name + Icon -->
        <div class="flex items-center space-x-3 w-full md:w-1/3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-yellow-500">
          ...
          <span class="text-[15px] text-black font-medium">College of Business Administration (CBA)</span>
        </div>
      ...
      <!-- 6 -->
      <a href="{{ route('documentsf6') }}" class="block hover:bg-gray-100 rounded-lg transition">
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center px-4">
        <!-- Name + Icon -->
        <div class="flex items-center space-x-3 w-full md:w-1/3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-yellow-500">
          ...
          <span class="text-[15px] text-black font-medium">College of Communication (COC)</span>
        </div>
      ...
      <!-- 7 -->
      <a href="{{ route('documentsf7') }}" class="block hover:bg-gray-100 rounded-lg transition">
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center px-4">
        <!-- Name + Icon -->
        <div class="flex items-center space-x-3 w-full md:w-1/3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-yellow-500">
          ...
          <span class="text-[15px] text-black font-medium">College of Computer and Information Sciences (CCIS)</span>
        </div>
      ...
      <!-- 8 -->
      <a href="{{ route('documentsf8') }}" class="block hover:bg-gray-100 rounded-lg transition">
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center px-4">
        <!-- Name + Icon -->
        <div class="flex items-center space-x-3 w-full md:w-1/3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-yellow-500">
          ...
          <span class="text-[15px] text-black font-medium">College of Education (CoEd)</span>
        </div>
      ...
      <!-- 9 -->
      <a href="{{ route('documentsf9') }}" class="block hover:bg-gray-100 rounded-lg transition">
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center px-4">
        <!-- Name + Icon -->
        <div class="flex items-center space-x-3 w-full md:w-1/3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-yellow-500">
          ...
          <span class="text-[15px] text-black font-medium">College of Engineering (CE)</span>
        </div>
