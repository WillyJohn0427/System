...
<head>
    ...
    <link rel="icon" href="{{ asset('Cheif_Images/images/QAC.jpeg') }}">
    ...
    <div class="space-y-3 mt-6">
      ...
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center px-4">
        ...
        <div class="flex items-center space-x-3 w-full md:w-1/3">
          ...
          <span class="text-[15px] text-black font-medium">BANSUDE, OREINTAL MINDORO</span>
        </div>
      ...
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center px-4">
        ...
        <div class="flex items-center space-x-3 w-full md:w-1/3">
          ...
          <span class="text-[15px] text-black font-medium">MARIVELS, BATAAN</span>
        </div>
