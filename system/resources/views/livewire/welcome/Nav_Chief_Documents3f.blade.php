...
<div class="flex-1 bg-gray-100 pt-[20px] ml-[320px] mr-[50px]">
  <div class="flex justify-between items-center mb-5">
    ...
    <div class="mb-5 flex flex-col items-start">
        ...
        <!-- New Button + Title -->
        <div >
        <h2 class="text-2xl font-bold ml-[30px] cursor-pointer"> Main Campus > College of Arts and Letters (CAL) </h2>
        </div>
      </div>
      ...
      <div class="flex items-center space-x-4 mr-[30px]">
        ...
        <form id="uploadForm" method="POST" action="{{ route('uploadFile') }}" enctype="multipart/form-data">
          ...
          <button class="flex rounded-2xl overflow-hidden border border-red-900">
            ...
            <a href="{{ route('documents2f') }}" class="bg-white px-4 py-2 flex items-center justify-center">
...
<div class="space-y-3 mt-6">
  <!-- Single row -->
  <a href="{{ route('documents33') }}" class="block">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center px-4 hover:bg-gray-100 rounded-lg transition">
      <!-- Name + Icon -->
      <div class="flex items-center space-x-3 w-full md:w-1/3">
        ...
        <span class="text-[15px] text-black font-medium">AACCUP Certificate</span>
      </div>
