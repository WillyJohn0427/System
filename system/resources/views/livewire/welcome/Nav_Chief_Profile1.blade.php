            ...
            <ul>
                <ul>
                    ...
                    <ul>
                        ...
                        <!-- Users -->
                        <li class="mb-4">
                            <a href="{{ route('users') }}" class="flex items-center space-x-4 p-2 hover:border-red-800 group transition duration-200">
        ...
        <div class="flex flex-col items-center w-full h-screen pl-[223px] padding-top: 700px pt-[180px] ">
            ...
            <div class="bg-white shadow-md w-full max-w-6xl rounded-t-2xl  rounded-b-2xl pb-[5px]">
                ...
                <div class="flex ml-8 mt-[25px] ">
                    <a href="{{ route('profile1') }}" class="px-4 pr-[187px] py-2 text-lg font-[600] text-white rounded-xl bg-red-900">Profile</a>
                </div>
                ...
                <div class="flex ml-8 mt-2">
                    <a href="{{ route('backup') }}" class="px-4 pr-[141px] py-2 text-lg font-[600] text-black rounded-xl hover:bg-red-900 transition-all hover:text-white">Backup Files</a>
                </div>
        
                <!-- Profile Section -->
                <div class="p-6 max-w-[500px] ml-[330px] -mt-[224px]">
