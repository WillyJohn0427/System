       ...
       <!-- New Button -->
        ...
        <form id="uploadForm" method="POST" action="{{ route('uploadFile') }}" enctype="multipart/form-data">
          ...
          <button class="flex rounded-2xl overflow-hidden border border-red-900">
            ...
            <a href="{{ route('documents5f') }}" class="bg-gray-100 px-3 py-2 flex items-center justify-center">
...
<div class="grid grid-cols-7 gap-2">
    <!-- Folder Item 1 -->
    <a href="{{ route('documents44') }}" class="group">
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">     <!-- Folder Icon -->
      <div class="relative w-32 h-32">
        ...
        <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
          <img src="{{asset('images/Chief_images/COPC.png')}}" alt="QAC" class="w-[55px] h-[55px]" />
        </div>
      ...
      <span class="block mt-2 text-sm font-semibold max-w-[150px] line-clamp-2">Certificate of Compliance (COPC)</span>
    </div>
    </a>
