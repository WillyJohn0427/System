        ...
        <main class="flex flex-col items-center w-[full] mt-4 p-4 pt-[164px] pl-60">
             ...
             <div class="bg-white shadow-md w-full max-w-6xl rounded-t-2xl  rounded-b-2xl pb-[193px]">
                ...
                <div class="flex ml-8 mt-2">
                    <a href="{{ route('password1') }}" class="px-4 pr-[164px] py-2 text-lg font-[600] text-white rounded-xl bg-red-900">Password</a>
                </div>
                <div class="flex ml-8 mt-2">
                ...
                <!-- Profile Section -->
                <div class="p-6 max-w-[500px] ml-[330px] -mt-[224px] pb-[97px]">
