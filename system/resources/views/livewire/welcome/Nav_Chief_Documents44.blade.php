       ...
       <!-- New Button -->
        ...
        <form id="uploadForm" method="POST" action="{{ route('uploadFile') }}" enctype="multipart/form-data">
          ...
          <button class="flex rounded-2xl overflow-hidden border border-red-900">
            ...
            <a href="{{ route('documents55') }}" class="bg-gray-100 px-3 py-2 flex items-center justify-center">
...
<div class="grid grid-cols-7 gap-4 mt-12 ml-6">
  <!-- Example File 1 -->
  <div class="flex flex-col items-center cursor-pointer group" onclick="openImageModal('images/Chief_images/BSED Major in English 2024.pdf.png')">
    <div class="w-[120px] h-full flex items-center justify-center overflow-hidden rounded-lg bg-gray-100">
      <img src="{{asset('images/Chief_images/BSED Major in English 2024.pdf.png')}}" alt="File Thumbnail" class="object-cover w-full h-full group-hover:scale-105 transition">
    </div>
    <div class="mt-2 text-center w-full">
      <p class="text-[13px] font-medium text-gray-800 truncate">BSED Major in English 2024.png</p>
    </div>
  </div>

  <!-- Example File 2 -->
  <div class="flex flex-col items-center cursor-pointer group" onclick="openImageModal('images/Chief_images/BSED Major in mathematics 2024.pdf.png')">
    <div class="w-[120px] h-full flex items-center justify-center overflow-hidden rounded-lg bg-gray-100">
      <img src="{{asset('images/Chief_images/BSED Major in mathematics 2024.pdf.png')}}" alt="File Thumbnail" class="object-cover w-full h-full group-hover:scale-105 transition">
    </div>
    <div class="mt-2 text-center w-full">
      <p class="text-[13px] font-medium text-gray-800 truncate">BSED Major in Mathematics 2024.png</p>
    </div>
  </div>
