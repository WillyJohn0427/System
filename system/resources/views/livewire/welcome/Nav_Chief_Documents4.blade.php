      ...
      <div class="flex items-center space-x-4 mr-[30px]">
        <button class="bg-white text-red-900 text-lg px-4 py-1.5 ml-[30px] mt-2.5 rounded-2xl font-semibold border border-red-900 flex items-center space-x-2 hover:bg-red-900 hover:text-white transition-all mb-2">
          ...
          <button class="flex rounded-2xl overflow-hidden border border-red-900">
            ...
            <a href="{{ route('documents5') }}" class="bg-gray-100 px-3 py-2 flex items-center justify-center">
...
<div class="grid grid-cols-7 gap-2">
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">     <!-- Folder Icon -->
      <div class="relative w-32 h-32">
        ...
        <div class="absolute inset-0 flex items-center justify-center mt-[68px] ml-5">
          <img src="{{asset('images/Chief_images/QAC.jpeg')}}" alt="QAC" class="w-[55px] h-[55px]" />
        </div>
      ...
      <span class="block mt-2 text-sm font-semibold max-w-[150px] line-clamp-2">ALFONSO, CAVITE</span>
    </div>
    </a>
  
    <!-- Folder Item 2 -->
    <a href="{{ route('documents4f') }}" class="group">
      <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">     <!-- Folder Icon -->
      <div class="relative w-32 h-32">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
          class="w-[150px] h-[150px] text-yellow-500">
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">     <div class="relative w-32 h-32">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
            class="w-[150px] h-[150px] text-yellow-500">
            <path
              d="M19.906 9c.382 0 .749.057 1.094.162V9a3 3 0 0 0-3-3h-3.879a.75.75 0 0 1-.53-.22L11.47 3.66A2.25 2.25 0 0 0 9.879 3H6a3 3 0 0 0-3 3v3.162A3.756 3.756 0 0 1 4.094 9h15.812ZM4.094 10.5a2.25 2.25 0 0 0-2.227 2.568l.857 6A2.25 2.25 0 0 0 4.951 21H19.05a2.25 2.25 0 0 0 2.227-1.932l.857-6a2.25 2.25 0 0 0-2.227-2.568H4.094Z" />
        ...
        <span class="block mt-2 text-sm font-semibold max-w-[150px] line-clamp-2">BIÑAN, LAGUNA</span>
      </div>
      </a>
    ...
    <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">   <!-- Folder Icon -->
        ...
        <span class="block mt-2 text-sm font-semibold max-w-[150px] line-clamp-2">CABIAO, NUEVA ECIJA</span>
      </div>
      </a>
      ...
      <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">    <!-- Folder Icon -->
        ...
        <span class="block mt-2 text-sm font-semibold max-w-[150px] line-clamp-2">CALAUAN, LAGUNA</span>
      </div>
      </a>
      ...
      <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">     <!-- Folder Icon -->
        ...
        <span class="block mt-2 text-sm font-semibold max-w-[150px] line-clamp-2">GENERAL LUNA, QUEZON</span>
      </div>
      </a>
      ...
      <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">     <!-- Folder Icon -->
        ...
        <span class="block mt-2 text-sm font-semibold max-w-[150px] line-clamp-2">LOPEZ, QUEZON</span>
      </div>
      </a>
      ...
      <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">     <!-- Folder Icon -->
       <!-- Folder Icon -->
        ...
        <span class="block mt-2 text-sm font-semibold max-w-[150px] line-clamp-2">MARAGONDON, CAVITE</span>
      </div>
      </a>
      ...
      <!-- Folder Item 10 -->
      <a href="{{ route('documentsb10') }}" class="group">
      <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">     <!-- Folder Icon -->
     <!-- Folder Icon -->
        <div class="relative w-32 h-32">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
        ...
        <span class="block mt-2 text-sm font-semibold max-w-[150px] line-clamp-2">MULANAY, QUEZON</span>
      </div>
      </a>

      <!-- Folder Item 11 -->
      <a href="{{ route('documentsb11') }}" class="group">
      <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">     <!-- Folder Icon -->
     <!-- Folder Icon -->
        <div class="relative w-32 h-32">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
        ...
        <span class="block mt-2 text-sm font-semibold max-w-[150px] line-clamp-2">PARAÑAQUE CITY</span>
      </div>
      </a>

      <!-- Folder Item 12 -->
      <a href="{{ route('documentsb12') }}" class="group">
      <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">     <!-- Folder Icon -->
     <!-- Folder Icon -->
        <div class="relative w-32 h-32">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
        ...
        <span class="block mt-2 text-sm font-semibold max-w-[150px] line-clamp-2">PULILAN, BULACAN</span>
      </div>
      </a>

      <!-- Folder Item 13 -->
      <a href="{{ route('documentsb13') }}" class="group">
      <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">     <!-- Folder Icon -->
     <!-- Folder Icon -->
        <div class="relative w-32 h-32">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
        ...
        <span class="block mt-2 text-sm font-semibold max-w-[150px] line-clamp-2">QUEZON CITY</span>
      </div>
      </a>

      <!-- Folder Item 1 -->
      <a href="{{ route('documentsb14') }}" class="group">
      <div class="relative flex flex-col items-center justify-start text-center min-h-[220px] transition-transform duration-200 group-hover:scale-105">     <!-- Folder Icon -->
      <!-- Folder Icon -->
        <div class="relative w-32 h-32">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
        ...
        <span class="block mt-2 text-sm font-semibold max-w-[150px] line-clamp-2">RAGAY, CAMARINES SUR</span>
      </div>
      </a>
