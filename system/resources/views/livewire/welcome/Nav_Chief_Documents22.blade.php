      ...
      <div class="flex items-center space-x-4 mr-[30px]">
        <button class="bg-white text-red-900 text-lg px-4 py-1.5 ml-[30px] mt-2.5 rounded-2xl font-semibold border border-red-900 flex items-center space-x-2 hover:bg-red-900 hover:text-white transition-all mb-2">
          ...
          <button class="flex rounded-2xl overflow-hidden border border-red-900">
            ...
            <a href="{{ route('documents33') }}" class="bg-gray-100 px-3 py-2 flex items-center justify-center">
...
<div class="grid grid-cols-7 gap-4 mt-12 ml-6">
  <!-- Example File 1 -->
  <div class="flex flex-col items-center cursor-pointer group" onclick="openImageModal('images/Chief_images/Bachelor of Arts in Math 2014.pdf.png')">
    <div class="w-full h-[120px] flex items-center justify-center overflow-hidden rounded-lg bg-gray-100">
      <img src="{{asset('images/Chief_images/Bachelor of Arts in English 2014.pdf.png')}}" alt="File Thumbnail" class="object-cover w-full h-full group-hover:scale-105 transition">
    </div>
    <div class="mt-2 text-center w-full">
      <p class="text-[13px] font-medium text-gray-800 truncate">Bachelor of Arts in English 2014.png</p>
    </div>
  </div>
  ...
  <div class="flex flex-col items-center cursor-pointer group" onclick="openImageModal('images/Chief_images/Bachelor of Arts in Math 2014.pdf.png')">
    <div class="w-full h-[120px] flex items-center justify-center overflow-hidden rounded-lg bg-gray-100">
      <img src="{{asset('images/Chief_images/Bachelor of Arts in Math 2014.pdf.png')}}" alt="File Thumbnail" class="object-cover w-full h-full group-hover:scale-105 transition">
    </div>
    <div class="mt-2 text-center w-full">
      <p class="text-[13px] font-medium text-gray-800 truncate">Bachelor of Arts in Math 2014.png</p>
    </div>
  </div>

  <!-- Example File 3 -->
  <div class="flex flex-col items-center cursor-pointer group" onclick="openImageModal('images/Chief_images/Bachelor of Arts in English 2014.pdf.png')">
    <div class="w-full h-[120px] flex items-center justify-center overflow-hidden rounded-lg bg-gray-100">
      <img src="{{asset('images/Chief_images/Bachelor of Arts in English 2014.pdf.png')}}" alt="File Thumbnail" class="object-cover w-full h-full group-hover:scale-105 transition">
    </div>
    <div class="mt-2 text-center w-full">
