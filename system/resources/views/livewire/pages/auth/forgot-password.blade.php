        ...
        style="background-image: url('{{ asset('images/LandingPage_Images/Background.png') }}')";>
            ...
            <div class="flex w-full h-full ">
                ...
                <div class=" flex-1.1 pl-[101px] bg-gray-100 flex flex-col items-center justify-center rounded-tl-[80px] p-6" >
                    ...
                    <div class="bg-gray-200 p-6 mr-[70px] -mt-[28px] flex justify-center items-center rounded-t-2xl w-[550px] min-h-[105px] md:drop-shadow-lg ">
                        <div class="flex-1 text-center text-[28px] tracking-[1px] font-bold text-red-900">Forgot Your Password?</div>
                    </div>
        
                        <!-- Main Container Holds Forgor Password Box -->
                        <div class="bg-white pt-[150px] pb-[35px] pr-[100px] pl-[100px] mr-[70px] drop-shadow-md md:drop-shadow-lg rounded-b-2xl rounded-t-2xl w-[550px] text-center -mb-[5px] -mt-[10px]">
                            <p class="text-[16px] text-gray-800 -mb-[20px] -mt-[30px]">No problem. Just let us know your email address and we will send you a password reset link.</p>
                        
                        
                            <!-- Main Container Holds Email Input Box -->
                            <div class="mt-6 pt-[40px] pb-[60px] p-6 rounded-lg -ml-[20px]">
                                <label class="block text-red-900 text-md font-bold text-left -mb-[3px]" >PUP Webmail*</label>
                                <input type="email" class=" inline-block w-[350px] p-2.5 border-[2.5px] h-[50px] mt-[10px] border-red-900 rounded-md" placeholder="Enter your Webmail.">
                            </div>
