                ...
                <ul>
                    <ul>
                        ...
                        <ul>
                            <!-- Dashboard -->
                            <li class="mb-4">
                                <a href="{{ route('dashboard') }}" class="flex items-center space-x-4 p-2 border-l-4 border-red-800 group transition duration-200">
                                    ...
                                    <span class="text-red-800 text-[21px] font-bold transition-all duration-200">Dashboard</span>
                                </a>
                            </li>
